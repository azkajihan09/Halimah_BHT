...
/**
 * Simple Test Script for BHT Jadwal Alignment
 */
...
echo "<h1>Test Simple BHT Jadwal Alignment</h1>\n";
...
try {
    ...
    // Test simplified query dari method get_jadwal_bht_harian yang baru
    echo "<h2>📋 Testing Simplified BHT Structure</h2>\n";
    ...
    echo "<h2>🎯 Simplified BHT Success Summary</h2>\n";
    ...
    echo "<ol>\n";
    echo "<li>✅ <strong>Model Simplified:</strong> Query hanya menggunakan tabel yang ada</li>\n";
    echo "<li>✅ <strong>Basic Columns:</strong> nomor_perkara, jenis_perkara, tanggal_putusan, tanggal_bht</li>\n";
    echo "<li>✅ <strong>New Columns:</strong> perkiraan_bht, status_bht, status_pengisian_bht</li>\n";
    echo "<li>✅ <strong>Filter Applied:</strong> Perkara permohonan (/Pdt.P/) excluded</li>\n";
    echo "<li>✅ <strong>Memory Fixed:</strong> LIMIT 100 untuk prevent memory exhaustion</li>\n";
    echo "</ol>\n";
    echo "<p><strong>Status:</strong> jadwal_bht_harian sekarang bisa berjalan tanpa error database!</p>\n";
    echo "</div>\n";
