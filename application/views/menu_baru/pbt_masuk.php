                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($pbt->selisih_hari !== null): ?>
                                                            <span class="badge <?= $pbt->selisih_hari > 7 ? 'badge-danger' : ($pbt->selisih_hari > 3 ? 'badge-warning' : 'badge-success') ?>">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="progress-group">
                                <span class="progress-text">Proses 1-3 Hari</span>
                                <span class="float-right"><b><?= array_reduce($pbt_masuk, function ($carry, $item) {
                                                                    return $carry + (($item->selisih_hari >= 1 && $item->selisih_hari <= 3) ? 1 : 0);
                            ...
                            <div class="progress-group">
                                <span class="progress-text">Proses 4-7 Hari</span>
                                <span class="float-right"><b><?= array_reduce($pbt_masuk, function ($carry, $item) {
                                                                    return $carry + (($item->selisih_hari >= 4 && $item->selisih_hari <= 7) ? 1 : 0);
                                                                }, 0) ?></b>/<?= count($pbt_masuk) ?></span>
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-warning" style="width: <?= count($pbt_masuk) > 0 ? (array_reduce($pbt_masuk, function ($carry, $item) {
                                                                                            return $carry + (($item->selisih_hari >= 4 && $item->selisih_hari <= 7) ? 1 : 0);
                                                                                        }, 0) / count($pbt_masuk)) * 100 : 0 ?>%"></div>
                                </div>
                            </div>
                            <div class="progress-group">
                                <span class="progress-text">Proses > 7 Hari</span>
                                <span class="float-right"><b><?= array_reduce($pbt_masuk, function ($carry, $item) {
                                                                    return $carry + (($item->selisih_hari > 7) ? 1 : 0);
                                                                }, 0) ?></b>/<?= count($pbt_masuk) ?></span>
                                <div class="progress progress-sm">
