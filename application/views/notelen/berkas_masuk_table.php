                                ...
                                <?php if (isset($berkas_list) && !empty($berkas_list)): ?>
                                    <?php foreach ($berkas_list as $index => $berkas): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <small><?= isset($berkas->majelis_hakim) ? $berkas->majelis_hakim : '-' ?></small>
                                            </td>
                                            <td>
                                                <?php 
                                                ...
                                                if ($hari_sejak_putusan <= 14): ?>
                                                    <span class="badge badge-custom" style="background-color: #28a745;">✓ Sudah BHT</span>
                                                <?php else: ?>
                                                    <span class="badge badge-custom" style="background-color: #dc3545;">Hari ini (Deadline)</span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <span class="badge badge-custom" style="background-color: #6c757d;">
                                                    (+<?= $hari_sejak_putusan ?> hari kerja)
                                                </span>
                                            </td>
                                            <td>
                                                <?php if ($hari_sejak_putusan <= 14): ?>
                                                    <span class="badge badge-custom" style="background-color: #28a745;">✓ Tepat Waktu</span>
                                                <?php else: ?>
                                                    <span class="badge badge-custom" style="background-color: #dc3545;">✗ Terlambat</span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php 
                                                ...
                                                ?>
                                                <span class="badge badge-custom" style="background-color: #17a2b8;">
                                                    📅 <?= $tanggal_14_hari ?>
                                                </span>
                                            </td>
                                            <td>
                                                ...
                                                $badge_class = '';
                                                switch($status) {
                                                    case 'MASUK': $badge_class = 'badge-masuk'; break;
                                                    case 'PROSES': $badge_class = 'badge-proses'; break;
                                                    case 'SELESAI': $badge_class = 'badge-selesai'; break;
                                                    case 'KELUAR': $badge_class = 'badge-keluar'; break;
                                                    default: $badge_class = 'badge-masuk';
                                                }
                                                ?>
