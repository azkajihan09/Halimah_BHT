	...
	public function ajax_get_berkas()
	{
		...
		echo json_encode(array(
			...
			'berkas' => array(
				...
				'tanggal_register' => isset($berkas->tanggal_register) ? $berkas->tanggal_register : '',
				...
				'jurusita' => isset($berkas->jurusita) ? $berkas->jurusita : '',
	...
	public function ajax_insert_berkas_direct()
	{
		...
		try {
			...
			$data = array(
				...
				'tanggal_register' => !empty($tanggal_register) ? $tanggal_register : date('Y-m-d'),
				'tanggal_masuk_notelen' => null, // SELALU NULL untuk input baru - harus diisi manual
